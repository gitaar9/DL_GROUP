...
def composer_with_at_least(folder_path, slices, songs, less_than_songs=999):
    ...
    return qualified_composers, total_slices


if __name__ == '__main__':
    composers, total_slices = composer_with_at_least('./data/midi_files_npy_8_40/', 40, 8, 40)
    print(len(composers), total_slices, composers)
