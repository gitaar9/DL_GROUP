...
def parse_arguments():
    ...
    return args.epochs, args.optimizer, args.num_layers, args.hidden_size, args.dropout, args.chunks, args.pretrain
...
if __name__ == '__main__':
    ...
    file_name = format_filename("advanced_lstm_11", arguments)
