...
from torchvision.models.densenet import model_urls as dense_model_urls, DenseNet
from torchvision.models.resnet import BasicBlock, model_urls as res_model_urls, ResNet
